...
public class Rotation2d {
    ...
    public Rotation2d(double x, double y) {
        ...
        if (magnitude > 1e-6) {
            ...
            m_cos = 1.0;
            m_sin = 0.0;
            System.err.println("x and y components of Rotation2d are zero");
        }
     ...
     * @see java.lang.Math#IEEEremainder(double, double) to constrain the angle
     *      within (-π, π]
     */
